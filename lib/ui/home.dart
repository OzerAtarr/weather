...
class _HomeState extends State<Home> {
  ...
  int temperature = 0;
  int maxTemp = 0;
  String weatherStateName = 'Yükleniyor...';
  int humidity = 0;
  int windSpeed = 0;

  var currentDate = 'Yükleniyor...';
  String imageUrl = '';
  int woeid =
  ...
  Future<void> fetchWeather(String location) async {
    final String apiUrl = searchLocationUrl + location;
    ...
    if (response.statusCode == 200) {
      // API'den başarılı yanıt alındığında
      final Map<String, dynamic> data = jsonDecode(response.body);
      print('gelen sonuc $data testsa'); // Veriyi konsola yazdırma
    } else {
      // Hata durumunda
